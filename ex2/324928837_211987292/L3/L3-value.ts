...
import { isPrimOp, CExp, PrimOp, VarDecl, Binding, ClassExp } from './L3-ast';
...
export const makeObject = (class_val: Class, args: Value[]): Object =>
    ({tag: "Object", class_val: class_val, args: args, env : makeEmptyEnv()});
export const makeObjectEnv = (class_val: Class, args: Value[], env: Env): Object =>
    ({tag: "Object",class_val: class_val, args: args, env: env});
