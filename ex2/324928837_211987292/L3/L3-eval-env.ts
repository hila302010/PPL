...
import { isClosure, makeClosureEnv, Closure, Value, Class, makeClass, makeClassEnv, isClass, isObject, makeObjectEnv, isSymbolSExp, Object, valueToString } from "./L3-value";
...
const applyClass = (proc: Class, args: Value[]): Result<Value> => makeOk(makeObjectEnv(proc, args, makeExtEnv(map((x: VarDecl)=>x.var ,proc.fields), args, proc.env)))
